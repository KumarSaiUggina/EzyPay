      ...
      <div className="container mx-auto px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="space-y-4">
            <h3 className="text-lg font-semibold">EzyPay</h3>
            <p className="text-sm">
              Simplifying your finances with secure and seamless digital
              payments.
            </p>
            <p className="text-sm">© {year} EzyPay. All rights reserved.</p>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4 mb-4">
              <a
                href="https://github.com/KumarSaiUggina"
                target="_blank"
              ...
              <a
                href="https://x.com/KumarsaiUggina"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://www.linkedin.com/in/kumarsaiuggina/"
                target="_blank"
                rel="noopener noreferrer"
            ...
            <div>
              <a
                href={`mailto:uggina.kumarsai@gmail.com`}
        ...
        <div className="mt-8 pt-8 border-t border-slate-300 text-center text-sm text-gray-500">
          <p>EzyPay is a registered trademark of EzyPay, Inc.</p>
        </div>
      </div>
    </footer>
  );
