      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20 sm:py-32">
        ...
        >
          <motion.div variants={itemVariants} className="space-y-6">
            <h1 className="relative mx-auto max-w-5xl text-5xl font-extrabold tracking-tight text-gray-900 sm:text-6xl md:text-7xl font-sans">
              Simplify Your Finances with{" "}
              <span className="bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">
                EzyPay
              </span>
            </h1>
            <p className="mt-8 max-w-3xl mx-auto text-lg text-gray-600 font-medium leading-relaxed text-center">
              Experience seamless fund management, expense tracking, and secure
              money transfers with{" "}
              <span className="font-semibold text-blue-600">EzyPay</span> — your
              all-in-one digital e-wallet solution.
            </p>
          </motion.div>
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-12">
            ...
            <HowItWorksStep
              number={2}
              title="Add Funds"
              description="Easily transfer money from your bank account to your EzyPay wallet."
            />
            <HowItWorksStep
              number={3}
        ...
        >
          ...
          <p className="text-xl text-gray-600 mb-12 max-w-2xl mx-auto">
            ...
            EzyPay. Start your journey to smarter financial management today.
          </p>
          <Link href="/api/auth/signin">
            <button className="group relative inline-flex items-center justify-center rounded-full bg-gradient-to-r from-blue-600 to-indigo-600 px-8 py-4 text-lg font-medium text-white hover:from-blue-700 hover:to-indigo-700 transition-all duration-200 shadow-lg hover:shadow-xl">
              Create Your EzyPay Account
              <ArrowRight className="ml-2 h-6 w-6 transform transition-transform group-hover:translate-x-1" />
            </button>
          </Link>
        </motion.div>
