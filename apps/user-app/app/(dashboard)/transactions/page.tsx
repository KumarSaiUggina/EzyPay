...
export const metadata: Metadata = {
  title: 'Transactions | EzyPay',
  description: 'Track all your transactions effortlessly with EzyPay digital wallet application',
}
    ...
    <div className="w-full px-4 sm:px-6 lg:px-8">
      <div className="flex justify-center md:text-4xl mt-20 font-extrabold">
        <h1 className="text-3xl sm:text-4xl font-extrabold text-slate-800">
          <span className="text-blue-600">EzyPay </span>Transactions
        </h1>
      </div>
