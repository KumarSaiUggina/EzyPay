...
export const metadata: Metadata = {
  title: 'Privacy Policy | EzyPay',
  description: 'Privacy Policy for EzyPay digital wallet application',
};
      ...
      <div className="max-w-3xl mx-auto pt-20">
        <div className="text-center mb-12">
          <h1 className="text-3xl sm:text-4xl font-extrabold text-slate-800">
            <span className="text-blue-600">EzyPay </span>Privacy Policy
          </h1>
        ...
        <div className="space-y-6 text-gray-600">
          <section>
            ...
            <p>
              Welcome to EzyPay's Privacy Policy. This policy describes how we
          ...
          <section>
            ...
            <p>
              ...
              contact us at privacy@ezypay.com.
            </p>
          </section>
